const paths = {
  ...
  database:
    "M4 5c0-1.1 3.6-2 8-2s8 .9 8 2-3.6 2-8 2-8-.9-8-2Zm0 0v14c0 1.1 3.6 2 8 2s8-.9 8-2V5M4 12c0 1.1 3.6 2 8 2s8-.9 8-2",
  star: "m12 3 2.6 5.6 6.1.5-4.6 4 1.4 6L12 15.8 6.5 19.1l1.4-6-4.6-4 6.1-.5L12 3Z",
  shield: "M12 3 5 6v6c0 5 3.5 7.5 7 9 3.5-1.5 7-4 7-9V6l-7-3Z",
  lock: "M7 10V8a5 5 0 0 1 10 0v2M5 10h14v9H5v-9Z",
};
